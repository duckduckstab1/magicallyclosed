                ...
                },*/
                {
                    ...
                    value: function (a) {
                        var b = BonziHandler.stage;
                            ...
                            this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(new createjs.SpriteSheet({ images: ["./img/bonzi/" + this.color + ".png"], frames: BonziData.sprite.frames, animations: BonziData.sprite.animations }), a ? "gone" : "idle")));
...
var undefined,
    ...
    socket = io("http://bonziworldrevived.tk",{query:{ channel: "bonziuniverse-revived" }}),
	call,
    usersPublic = {},
    bonzis = {},
    debug = !0;	
$(function () {
    ...
    $("#register_error_button").click(function () {
        $("#page_restricted_command").hide();
    });
