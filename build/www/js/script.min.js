		...
		items: {
			wallpapers: {
				...
				items: {
					...
					davinci: { name: "Da Vinci", callback: function () { theme('#content{background:url("/img/desktop/Da Vinci/bg_xpdavinci.png")}#chat_bar{background:url("/img/desktop/Da Vinci/taskbar_xpdavinci.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/Da Vinci/start_davinci.png")}') } },
					aero: { name: "Aero", callback: function () { theme('#content{background:url("/img/desktop/background_7.png")}#chat_bar{background:url("/img/desktop/aero/taskbar.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/aero/start.png")}') } }
				}
			},
			update: {
				name: "See Updates",
