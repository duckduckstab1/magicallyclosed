                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autowidth');
                            this.$dialogCont.html("<video controls height='270'><source src='" + a + "' type='video/mp4'></video>"), this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialog.addClass('bubble_autowidth');
                            this.$dialogCont.html("<audio controls loop><source src='" + a + "' type='audio/mp3'></source></audio>"), this.$dialog.show();
                        }
                    },
                },
                {
		...
		items: {
			wallpapers: {
				...
				items: {
					...
					space: { name: "Space", callback: function () { theme('#content{background:url("/img/desktop/Space/bg_xpspace.png")}#chat_bar{background:url("/img/desktop/Space/taskbar_xpspace.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/Space/start_xpspace.png")}') } },
					aquarium: { name: "Aquarium", callback: function () { theme('#content{background:url("/img/desktop/Aquarium/bg_xpaquarium.png")}#chat_bar{background:url("/img/desktop/Aquarium/taskbar_xpaquarium.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/Aquarium/start_xpaquarium.png")}') } },
					nature: { name: "Nature", callback: function () { theme('#content{background:url("/img/desktop/Nature/bg_xpnature.png")}#chat_bar{background:url("/img/desktop/Nature/taskbar_xpnature.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/Nature/start_xpnature.png")}') } },
					davinci: { name: "Da Vinci", callback: function () { theme('#content{background:url("/img/desktop/Da Vinci/bg_xpdavinci.png")}#chat_bar{background:url("/img/desktop/Da Vinci/taskbar_xpdavinci.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/Da Vinci/start_xpdavinci.png")}') } },
					aero: { name: "Aero", callback: function () { theme('#content{background:url("/img/desktop/background_7.jpg")}#chat_bar{background:url("/img/desktop/aero/taskbar.png")}#chat_tray{display:none}#chat_send{background:url("/img/desktop/aero/start.png")}') } }
				}
			},
			update: {
				name: "See Updates",
