...
var peedy = new Agent("Peedy", {
    size: { x: 160, y: 128 },
    frameSize: { width: 160, height: 128 },
    extras: { nameplateOffset: 15 },
    animations: {
        idle: 0,
        surf_away: { frames: range(377, 400), next: "gone", ticks: 52, speed: 1},
        surf_intro: { frames: range(6, 28), next: "idle", ticks: 25, speed: 1},
        shrug_fwd: { frames: range(253, 260), next: "shrug_still", ticks: 25, speed: 1},
        shrug_still: 260,
        shrug_back: { frames: range(260, 253), next: "idle", ticks: 25, speed: 1},
        sad_fwd: { frames: range(268, 272), next: "sad_still", ticks: 25, speed: 1},
        sad_still: 272,
        sad_back: { frames: range(272, 268), next: "idle", ticks: 25, speed: 1},
        praise_fwd: { frames: range(91, 95), next: "praise_still", ticks: 25, speed: 1},
        praise_still: 95,
        praise_back: { frames: range(95, 91), next: "idle", ticks: 25, speed: 1},
        cool_fwd: { frames: range(617, 632), next: "cool_still", ticks: 25, speed: 1},
        cool_still: 632,
        cool_back: { frames: range(632, 617), next: "idle", ticks: 25, speed: 1},
        gone: 400,
    },
}); 
...
function setup() {
    ...
    $("#chat_send").click(sendInput),
        ...
        socket.on("room", function (a) {
			var sfx = new Audio("/sfx/ab_logon.wav");
            if (a.room == "news") { 
                $("#bonzi_tv").html("<div id='bonzi_tv_player' style='position: absolute; overflow: hidden; width: 100%; height: 100%; pointer-events: none;'></div>")
                var youtube = new YT.Player("bonzi_tv_player", {
                    height: "80%",
...
socket.on("broadcast", function(a) {
   ...
   socket.on("admin",function(){
       admin = true;
        ...
        socket.on("dtvhater", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.dtvhater(a.target);
        }),
		/*
            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: async function () {
                        0 === this.event.timer && ((this.event.timer = 1), await this.talk(this.event.cur().text, this.event.cur().say, !0)), "none" == this.$dialog.css("display") && this.eventNext();
                    },
                },
                {
                    key: "updateIdle",
                ...
                },
                {
                    ...
                    value: async function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            (a = linkify(a));
							(b = b.replace(/\u005B/gi, "idiot "));
							(b = b.replace(/\u005D/gi, " idiot"));
							(b = b.replace(/~/gi,"?")); // :trollface:
                        var e = "&gt;" == a.substring(0, 4) || ">" == a[0];
                            this.$dialogCont[c ? "html" : "text"]( twemoji.parse(a) )[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                            ...
                            if (useSapi5) {
                                ...
                                if (this.userPublic.voice == "jennifer") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/jennifer?text="+b)
                                    if (window.gain > 1) {

                                        
                                        // create an audio context and hook up the video element as the source
                                        var audioCtx = new (window.AudioContext || window.webkitAudioContext)();
                                        var source = audioCtx.createMediaElementSource(this.aud);
                                        // create a gain node
                                        var gainNode = audioCtx.createGain();
                                        gainNode.gain.value = window.gain; // double the volume
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/eric?text="+b)
                                    if (window.gain > 1) {
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/joey?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "brian") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/brian?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "karl") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/karl?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "mads") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/mads?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "ricardo") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/ricardo?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "ivy") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/ivy?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "russell") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/russell?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"]( twemoji.parse(a) )[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    this.aud.onended = function() {
                                        d.clearDialog();
                                    }
                                } else if (this.userPublic.voice == "sally") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/sally?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "justin") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/justin?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "damien") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/damien?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "willfromafar") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    this.aud = await new Audio("https://mespeak-engine.daisreich.repl.co/willfromafar?text="+b)
                                    if (window.gain > 1) {
                                ...
                                } else if (this.userPublic.voice == "sapi4") {
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    if (this.color == "peedy") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=100&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        await this.aud.play();
                                    } else if (this.color == "qmark") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=100&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        await this.aud.play();
                                    } else if (this.color == "pm") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=80&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        await this.aud.play();
                                    } else if (this.color == "clippy") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        await this.aud.play();
                                    } else if (this.color == "red_clippy") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Female%20%231%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        await this.aud.play();
                                    } else if (this.color == "fujitsu") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=English-American%3A%20Default%20(English)&pitch=118&speed=17")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=RoboSoft%20Three&pitch=113&speed=170")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%237%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=140&speed=157")
                                        if (window.gain > 1) {
                ...
                },
                {
                    key: "dtvhater",
                    value: function (a) {
                        this.runSingleEvent([{ type: "text", text: "Hey, " + a + "!" }, { type: "text", text: "You're a fucking DTV hater!", say: "your a fucking DTV hater!" }, { type: "anim", anim: "grin_fwd", ticks: 15 }, { type: "idle" }]);
                    },
                },
                {
                    key: "beggar",
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_triggered = [
        ...
        {
            type: "text",
            text: "I want to become BonziBUDDY. Ever since I was a young boy I dreamed of invading desktops dropping hot sticky tootorals on disgusting, foolish PC users.",
            say: "I want to become BonziBUDDY. Ever since I was a young boy I dreamed of invading desktops, dropping hot sticky tootorals on disgusting, foolish PC users.",
        },
        {
            type: "text",
            text: "People say to me that a person being BonziBUDDY would infect the entire world with the virus, but I don’t care, I want to become him anyway.",
            say: "People say to me that a person being BonziBUDDY would infect the entire world with the virus, but I don't care, I want to become him anyway.",
        },
        {
            type: "text",
            text: "I'm having an IT intern install Internet Explorer 6, aquarium screensavers and PC Doctor 2016 on my computer, From now on I want you guys to call me “Joel” and would like you guys to allow me to meme from above any time i fucking want.",
            say: "I'm having an IT intern install Internet Explorer 6, aquarium screensavers and PC Doctor 2016 on my computer, From now on I want you guys to call me \"Joel\" and would like you guys to allow me to meme from above any time i fucking want.",
        },
        {
            type: "text",
            text: "If you hate me then i don't give two shits and you need to fuck off. Thank you for being so understanding.",
            say: "If you hate me then i don't give two shits and you need to fuck off. Thank you for being so understanding.",
        },
        { type: "idle" },
    ]),
...
var socket = io("//server.bonziworldrevived.tk:"+window.location.port,{query:{ channel: "bonziuniverse-revived" }});
...
$(function () {
    setTimeout(function(){
		...
		socket.on("achieve", function (a, p) {
                ...
                socket.on("enablePrivateRooms", function (data) {
                    $("#login_room").show();
                }),
