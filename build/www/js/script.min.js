...
function doMOTDRefresh(){
	$("#login_readme").load(" .motd > *");	
    }
...
setInterval(function(){
      $(".motd").load(" .motd > *");
                ...
                var datas = $.get("https://bonziworldrevived.tk/readme.json",
                        function (infos) {
                            $.ajax({
                                type: "POST",
                                ...
                                success: function (data) {
                                    if (data.hasOwnProperty('form')) {
                                        datas = data.form;
                                        $("<b>" + datas.motd + "</b><br>").prependTo(".motd");
					// dont use. it doesnt have styling support.
					//$("#login_readme").prepend("<b>" + datas.motd + "</b><br>");
                                    }
                                }
