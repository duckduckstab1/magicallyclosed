                        ...
                        var e = "&gt;" == a.substring(0, 4) || ">" == a[0];
                            ...
                            if (useSapi5) {
                                ...
                                if (this.userPublic.voice == "jennifer") {
                                    ...
                                    this.aud = await new Audio("./api/v0/tts/jennifer?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress>")
                                    this.aud = await new Audio("./api/v0/tts/eric?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    this.aud.onended = function() {
                                        d.clearDialog();
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress>")
                                    this.aud = await new Audio("./api/v0/tts/joey?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    this.aud.onended = function() {
                                        d.clearDialog();
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress>")
                                    this.aud = await new Audio("./api/v0/tts/brian?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    this.aud.onended = function() {
                                        d.clearDialog();
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress>")
                                    this.aud = await new Audio("./api/v0/tts/karl?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    this.aud.onended = function() {
                                        d.clearDialog();
                                    ...
                                    this.$dialog.css("display", "block");
                                    this.$dialogCont.html("<progress></progress>")
                                    this.aud = await new Audio("./api/v0/tts/mads?text="+b)
                                    await this.aud.play();
                                    this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").removeClass("bubble_autowidth").removeClass("bubble_media_player").css("display", "block"),
                                    this.aud.onended = function() {
                                        d.clearDialog();
