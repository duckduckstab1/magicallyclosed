...
var undefined,
    ...
    debug = !0;
$(function () {
                $(".login_button").click(loadTest),
                $(".login_input_room").val(window.location.hash.slice(1)),
                $(".login_input_username, .login_input_room").keypress(function (e) {
                    13 == e.which && login();
                }),
                socket.on("ban", function (data) {
                    (window.banned = !0), (window.banData = data), (ban_soundfx.play()), $("#page_ban").show(), $("#ban_reason").html(data.reason), $("#ban_end").html(new Date(data.end).toString());
                }),
                socket.on("kick", function (data) {
                    (window.kicked = !0), (window.kickData = data), (kick_soundfx.play()), $("#page_kick").show(), $("#kick_reason").html(data.reason);
                }),
